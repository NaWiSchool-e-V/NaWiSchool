/* ============================================
    ...
    Adalogger V3 with BME280 or MPU6050 and NEO-6M
    [This code is used to read and save the data from BME280 sensor or MPU6050 sensor and Neo-6M GPS module]
    Author: T. Schumann
    Date: 2023-08-11
